...
@{
    ...
    FunctionsToExport = @('New-SqliteDatabase','Invoke-SqliteQuery','Get-SqliteVersion','Get-SqliteConnection','Get-SqliteTableNames','Get-SqliteTableColumnNames','Get-SqliteColumnNamesAll')
